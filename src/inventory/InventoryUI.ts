...
export class InventoryUI {
  ...
  private initGlobalListeners() {
      ...
      window.addEventListener("touchend", (e) => {
          ...
          if (draggedItem && this.inventoryMenu.style.display !== 'none' && this.touchStartSlotIndex !== null) {
  ...
  private updateSlotVisuals(index: number) {
      ...
      elements.forEach(el => {
          if (el.parentElement === this.hotbarContainer) {
              if (index === this.inventory.getSelectedSlot()) el.classList.add("active");
